...
<br><div class="row">
	<div class="col-lg-12">
  <h4><font color='green'>Quote Number : {{Session::get('erporder')['order_number']}} &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Client: {{Session::get('erporder')['client']['firstname']}}  &nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;&nbsp; Date: {{Session::get('erporder')['date']}} </font></h4>
...
<div class="row">
   ...
   <!--  <div class="panel-heading"> -->
        ...
        <!-- </div> --><input type="submit" class="btn btn-success pull-right" value="Process"/>
