...
<div class="row">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
          <a class="btn btn-success btn-sm" href="{{ URL::to('payments/create')}}">new payment</a>
        </div>
    ...
    <table id="users" class="table table-condensed table-bordered table-responsive table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $payment->client->firstname.' '.$payment->client->other_names.' '.$payment->client->surname }}</td>
