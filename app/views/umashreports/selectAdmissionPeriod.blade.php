...
<div class="row">
	<div class="col-lg-5">
        ...
        @endif
		 ...
		 <form method="POST" action="{{URL::to('umashReports/admissions')}}" accept-charset="UTF-8" target="_blank">
    ...
    <fieldset>
       ...
       <div class="form-group">
        ...
        <div class="form-actions form-group">
          ...
          <button type="submit" class="btn btn-primary btn-success" >Select</button>
        </div>
