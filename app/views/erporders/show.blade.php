...
<br><div class="row">
	<div class="col-lg-12">
  <h4><font color='green'>Sales Order : {{$order->order_number}} &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Client: {{$order->client->firstname}}  &nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;&nbsp; Date: {{$order->date}} &nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;&nbsp; Status: {{$order->status}} </font> </h4>
...
<div class="row">
    ...
    <a href="{{URL::to('erpReports/receipt/'.$order->id)}}" class="btn btn-success"> Generate Receipt</a>
    </div>
</div>
