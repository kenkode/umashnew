...
<div class="footer">
   ...
   <div align="center"><strong>Admissions Report as from:  {{$from}} To:  {{$to}}</strong></div><br><br>
<hr>
    <table  class="table table-condensed table-bordered table-responsive table-hover">
      ...
      <tr>
       ...
       <td td width='20'>{{$i}}</td>
        ...
        <td> {{ $admission->date_of_death }}</td>        
        <td> {{ $admission->place_of_death }}</td>
        <td> {{ $admission->kin_firstname.' '.$admission->kin_surname }}</td>      
        </tr>
      <?php $i++; ?>
