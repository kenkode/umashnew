            ...
            <div class="col-lg-4">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <select disabled name="department_id" id="department_id" class="form-control">
                            <option></option>
                            <option value="cnew">Create New</option>
                     ...
                     <div class="form-group">
                        ...
                        <select disabled name="jgroup_id" id="jgroup_id" class="form-control">
                            <option></option>
                            <option value="cnew">Create New</option>
                     ...
                     <div class="form-group">
                        ...
                        <select disabled name="type_id" id="type_id" class="form-control">
                            <option></option>
                            <option value="cnew">Create New</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="right-inner-addon ">
                        <i class="glyphicon glyphicon-calendar"></i>
                        <input disabled class="form-control expiry" readonly="readonly" placeholder="" type="text" name="startdate" id="startdate" value="{{ $employee->start_date }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="right-inner-addon ">
                        <i class="glyphicon glyphicon-calendar"></i>
                        <input disabled class="form-control expiry" readonly="readonly" placeholder="" type="text" name="enddate" id="enddate" value="{{ $employee->end_date }}">
                        </div>
                     </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <input disabled class="form-control" placeholder="" type="text" name="work_permit_number" id="work_permit_number" value="{{{ $employee->work_permit_number }}}">
                    </div>

                    <div class="form-group">
                        <label for="username">Job Title</label>
                        <input disabled class="form-control" placeholder="" type="text" name="jtitle" id="jtitle" value="{{{ $employee->job_title }}}">
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <input disabled class="form-control" placeholder="" type="text" name="pay" id="pay" value="{{{ $employee->basic_pay }}}">
                        </div>
                    </div>
                     <div class="form-group">
                  ...
                  <div class="col-lg-4">
                     <div class="form-group">
                        ...
                        <select disabled name="supervisor" id="supervisor" class="form-control">
                            <option></option>
                            @if($count>0)
                  ...
                  <div class="checkbox">
                        <label>
                            <input disabled type="checkbox" value="{{{ $employee->in_employment }}}"<?= ($employee->in_employment=='Y')?'checked="checked"':''; ?> name="active">
                                In Employment
                        </label>
                    </div>
                  </div>
