...
<div class="row">
    ...
    <fieldset>
        ...
        <div class="form-group">
            <label for="username">Tank Capacity:</label>
            <input class="form-control" placeholder="" type="text" name="tank_capacity" id="tank_capacity" value="{{$car->tank_capacity}}">
        </div>
        ...
        <div class="form-actions form-group">
          ...
          <button type="submit" class="btn btn-success btn-sm">Update Hearse</button>
        </div>
