...
<br><div class="row">
	<div class="col-lg-12">
  <h4><font color='green'>Quote Number : {{$order->order_number}} &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Client: {{$order->client->firstname}}  &nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;&nbsp; Date: {{$order->date}} &nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;&nbsp; Status: {{$order->status}} </font> </h4>
...
<div class="row">
    ...
    <a href="{{URL::to('erpReports/quotation/'.$order->id)}}" class="btn btn-success"> View Quotation</a>
    <a href="{{URL::to('erpReports/invoice/'.$order->id)}}" class="btn btn-success"> Generate Invoice</a>
    </div>
</div>
